...
public class AutoDelete extends ListenerAdapter {
    ...
    public void onStringSelectInteraction(StringSelectInteractionEvent e) {
        ...
        Button btn1 = Button.danger("autodelete.btn.show."+ch.getId()+".enableDelPins", "Aktivieren").withEmoji(Emoji.fromFormatted(Emojis.pin()));
        Button btn2 = Button.danger("autodelete.btn.show."+ch.getId()+".enableDelBots", "Aktivieren").withEmoji(Emoji.fromFormatted(Emojis.slash()));
        Button btn3 = Button.danger("autodelete.btn.show."+ch.getId()+".enableDelUser", "Aktivieren").withEmoji(Emoji.fromFormatted(Emojis.user()));
        Button btn4 = Button.danger("autodelete.btn.show."+ch.getId()+".delete", "Löschen").withEmoji(Emoji.fromFormatted(Emojis.delete()));
        if(delPins.equals(Emojis.yes())) btn1 = Button.success("autodelete.btn.show."+ch.getId()+".disableDelPins", "Deaktivieren").withEmoji(Emoji.fromFormatted(Emojis.pin()));
        if(delBots.equals(Emojis.yes())) btn2 = Button.success("autodelete.btn.show."+ch.getId()+".disableDelBots", "Deaktivieren").withEmoji(Emoji.fromFormatted(Emojis.slash()));
        if(delUser.equals(Emojis.yes())) btn3 = Button.success("autodelete.btn.show."+ch.getId()+".disableDelUser", "Deaktivieren").withEmoji(Emoji.fromFormatted(Emojis.user()));
    ...
    public void onButtonInteraction(ButtonInteractionEvent e) {
        ...
        if(id.equals("delete")) {
            ...
            EmbedBuilder embed = new EmbedBuilder()
                    ...
                    .setThumbnail(e.getGuild().getIconUrl())
                    .setFooter(u.getUsername(), u.getEffectiveAvatarUrl());
            Button btn1 = Button.danger("autodelete.btn.show."+ch.getId()+".enableDelPins", "Aktivieren").withEmoji(Emoji.fromFormatted(Emojis.pin())).withDisabled(true);
            Button btn2 = Button.danger("autodelete.btn.show."+ch.getId()+".enableDelBots", "Aktivieren").withEmoji(Emoji.fromFormatted(Emojis.slash())).withDisabled(true);
            Button btn3 = Button.danger("autodelete.btn.show."+ch.getId()+".enableDelUser", "Aktivieren").withEmoji(Emoji.fromFormatted(Emojis.user())).withDisabled(true);
